...
class SocketCommand {
	...
	public connect(): void {
		...
		// 	socket_port = 8081;
		// }
		this._socket.connectByUrl("ws://23w99255u8.zicp.vip:34704/hall?id=A200044&token=eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJBMjAwMDQ0IiwiY3JlYXRlZCI6MTU1MjY1NDEwMjM5MywiZXhwIjoxNTUyNzc0MTAyfQ.BjJQWWmR7B0ClhQQu09uswMV-5l1iDfhXphQ2w09t3LKgcN-A-fsXAatXEyOlq9e2c6Sstq7GxgOTBeH_aWXhA");
