...
(function (TipsManager) {
    ...
    */
    function registerTips(attachment, descStr, effectType) {
    ...
    TipsManager.registerTips = registerTips;
    function unRegisterTips(attachment) {
    ...
    TipsManager.unRegisterTips = unRegisterTips;
    /**
    * 显示tips方法
    */
    function showTips(e) {
