...
var OtherPlayerView = (function (_super) {
    __extends(OtherPlayerView, _super);
    function OtherPlayerView() {
        return _super.call(this) || this;
    }
    OtherPlayerView.prototype.setCompareFlag = function (value) {
    ...
    OtherPlayerView.prototype.setPosition = function (position) {
        this._position = position;
        if (position == 5) {
            this._cardGroup.x = 216;
            this._cardGroup.y = 0;
            this._readyFlag.x = 222;
            this._readyFlag.y = 30;
            this._betImg.x = -1;
            this._betImg.y = 83;
        }
        else if (position == 1) {
            this._cardGroup.x = -124;
            this._cardGroup.y = 0;
            this._betImg.x = 78;
            this._betImg.y = 88;
            this._readyFlag.x = -38;
            this._readyFlag.y = 115;
        }
        else if (position == 2) {
            this._cardGroup.x = -54;
            this._cardGroup.y = 83;
            this._betImg.x = 77;
            this._betImg.y = 88;
            this._readyFlag.x = -38;
            this._readyFlag.y = 115;
            ...
            this._cardGroup.x = 46;
            this._cardGroup.y = 84;
            this._betImg.x = -116;
            this._betImg.y = 29;
            this._readyFlag.x = 65;
            this._readyFlag.y = 114;
        }
        else {
            this._cardGroup.x = 162;
            this._cardGroup.y = 84;
            this._betImg.x = -2;
            this._betImg.y = 86;
            this._readyFlag.x = 222;
    ...
    OtherPlayerView.prototype.setData = function (data) {
        _super.prototype.setData.call(this, data);
    };
    OtherPlayerView.prototype.reset = function () {
        _super.prototype.reset.call(this);
    };
    OtherPlayerView.prototype.initView = function () {
        ...
        this._zhuangFlag.x = 12;
        this._zhuangFlag.y = -8;
        ...
        this._nickNameTF.x = 78;
        this._nickNameTF.y = 12;
        ...
        this._kanpaied.x = this._cardGroup.x + 6;
        this._kanpaied.y = this._cardGroup.y + 50;
        this._giveuped.x = this._cardGroup.x + 6;
        this._giveuped.y = this._cardGroup.y + 50;
        this._bipaiFail.x = this._cardGroup.x + 6;
        this._bipaiFail.y = this._cardGroup.y + 50;
...
__reflect(OtherPlayerView.prototype, "OtherPlayerView");
//# sourceMappingURL=OtherPlayerView.js.map