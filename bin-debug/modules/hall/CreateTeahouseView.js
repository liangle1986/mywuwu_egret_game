 ...
 *
 */
var CreateTeahouseView = (function (_super) {
    __extends(CreateTeahouseView, _super);
    function CreateTeahouseView() {
        ...
        _this.difen = 1;
        _this._tabIndex = -1;
        _this.skinName = "CreateTeahouseSkin";
        return _this;
    }
    CreateTeahouseView.prototype.childrenCreated = function () {
    ...
    CreateTeahouseView.prototype.CheckBoxChange = function (evt) {
    ...
    CreateTeahouseView.prototype.show = function () {
        this._tabIndex = -1;
        this.showTabView(1);
    ...
    CreateTeahouseView.prototype.showTabView = function (tabIndex) {
    ...
    CreateTeahouseView.prototype.touchBindButtonHandler = function (clickTarget) {
        ...
        if (clickTarget == this.createBtn) {
            ...
            data["msgType"] = NetAction.teahouse_create;
            if (this._tabIndex == 1) {
    ...
    return CreateTeahouseView;
}(IFrameBase));
__reflect(CreateTeahouseView.prototype, "CreateTeahouseView");
//# sourceMappingURL=CreateTeahouseView.js.map